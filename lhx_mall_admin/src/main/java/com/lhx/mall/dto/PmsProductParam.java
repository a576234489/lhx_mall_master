...
public class PmsProductParam extends PmsProduct{
    ...
    private List<CmsPrefrenceAreaProductRelation> prefrenceAreaProductRelations;
    ...
    public List<CmsPrefrenceAreaProductRelation> getPrefrenceAreaProductRelations() {
        return prefrenceAreaProductRelations;
    }

    public void setPrefrenceAreaProductRelations(List<CmsPrefrenceAreaProductRelation> prefrenceAreaProductRelations) {
        this.prefrenceAreaProductRelations = prefrenceAreaProductRelations;
    }
}
